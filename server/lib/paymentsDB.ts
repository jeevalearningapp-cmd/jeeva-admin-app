...
export const paymentsDB = {
  async createPaymentCustomer(
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        stripe_customer_id:
          input.gateway === "stripe" ? input.stripeCustomerId : null,
        razorpay_customer_id:
          input.gateway === "razorpay" ? input.razorpayCustomerId : null,
        email: input.email,
  ...
  async updatePayment(
    ...
    if (update.razorpayPaymentId)
      updateData.razorpay_payment_id = update.razorpayPaymentId;
  ...
  async updateRefund(
    ...
    if (update.razorpayRefundId)
      updateData.razorpay_refund_id = update.razorpayRefundId;
