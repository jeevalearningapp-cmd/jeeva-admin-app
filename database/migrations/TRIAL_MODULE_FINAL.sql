-- Trial Module Schema - FINAL (Fixed with correct column names)
-- Date: November 30, 2025
-- Note: Using actual columns from modules table schema

-- ============================================================================
-- 1. Add columns to existing tables (matching actual schema)
-- ============================================================================

-- Add trial-related columns to modules
...
-- Add trial flags to other tables
...
-- Insert Trial Module (using correct column names)
INSERT INTO modules (title, description, is_trial, display_order, is_active)
VALUES (
  'Trial',
...
CREATE POLICY trial_attempts_insert ON trial_attempt_records
...
CREATE POLICY trial_learning_insert ON trial_learning_progress
FOR INSERT WITH CHECK (user_id = auth.uid());
...
CREATE POLICY trial_exam_attempts_insert ON trial_exam_attempts
FOR INSERT WITH CHECK (user_id = auth.uid());
