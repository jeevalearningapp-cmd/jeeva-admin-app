    ...
    <Box sx={{ py: 4 }}>
      ...
      {viewMode === 'topic-detail' && selectedTopic && (
        <Box>
          ...
          {/* Topic Tabs */}
          <Paper sx={{ mb: 3, border: '1px solid #E5E7EB', borderRadius: '16px' }}>
            <Tabs
              value={topicTab}
          ...
          {/* Tab Content */}
          {topicTab === 'core-notes' && <CoreNotesEditor topicId={selectedTopic.id} />}
          {topicTab === 'flash-content' && <FlashContentEditor topicId={selectedTopic.id} />}
          {topicTab === 'subtopics' && (
            <SubtopicList topicId={selectedTopic.id} onEditSubtopic={handleEditSubtopic} />
          )}
          {topicTab === 'validation' && <ContentValidation topic={selectedTopic} />}
        </Box>
      )}
      ...
      {viewMode === 'subtopic-detail' && selectedSubtopic && (
        <Box>
          ...
          {/* Tab Content */}
          {subtopicTab === 'video' && (
            <VideoLessonTab subtopic={selectedSubtopic} onUpdate={handleSubtopicUpdate} />
          )}
          {subtopicTab === 'reading' && (
            <LessonTextTab subtopic={selectedSubtopic} onUpdate={handleSubtopicUpdate} />
          )}
          {subtopicTab === 'podcast' && (
            <PodcastTab subtopic={selectedSubtopic} onUpdate={handleSubtopicUpdate} />
          )}
          {subtopicTab === 'mcqs' && (
            <MCQTab
