...
import { Box, Typography, Paper, Tabs, Tab, Alert, Chip } from "@mui/material";
import {
  SchoolOutlined,
  QuizOutlined,
  TimerOutlined,
  ...
  const moduleOptions = [
    {
      ...
      color: "#34C759",
      description:
        "Manage topics with Core Notes, Flash Content, and Subtopics (Video, Podcast, MCQs)",
    },
    {
      ...
      color: "#007aff",
      description:
        "Topic-wise practice questions organized by category and subdivision",
    },
    {
      ...
      color: "#FF9500",
      description:
        "Full exam simulator with Part A (Numeracy) and Part B (Clinical)",
    },
  ];
          ...
          {moduleOptions.map((module) => (
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                <Box sx={{ color: module.color, mr: 1.5 }}>{module.icon}</Box>
