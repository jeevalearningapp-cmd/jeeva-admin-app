...
export const PaymentsPage: React.FC = () => {
  ...
  const { payments, summary, isLoading, refund, isRefunding, refetch } =
    usePayments(filters);
    ...
    <Box>
      ...
      >
        ...
        <Button
          variant="outlined"
          startIcon={
            syncing ? <CircularProgress size={18} /> : <SyncOutlined />
          }
      ...
      {selectedPayment && (
        ...
        >
          ...
          >
            ...
            {(selectedPayment.amountChargedLocal ||
            ...
            >
              <Box>
                ...
                <Typography>
                  £{selectedPayment.originalAmount.toFixed(2)}
                </Typography>
              </Box>
              <Box>
                <Typography variant="caption" color="text.secondary">
            ...
            >
              <Box>
                ...
                <Chip
                  label={getGatewayLabel(selectedPayment.gateway)}
                  size="small"
                />
              </Box>
              <Box>
