...
} from '@/hooks/usePracticeQuestions'
import { PracticeQuestion, CreatePracticeQuestionInput } from '@/api/practiceQuestions'
...
export const PracticeQuestionManager: React.FC<PracticeQuestionManagerProps> = ({
    category,
    subdivision
}) => {
    ...
    const [formData, setFormData] = useState<CreatePracticeQuestionInput>({
        questionText: '',
    ...
    const { data: questions = [], isLoading } = usePracticeQuestions(category, subdivision)
    ...
    const handleOpenDialog = (question?: PracticeQuestion) => {
        if (question) {
    ...
    return (
        <Box>
            ...
            {isLoading ? (
                ...
                <Alert severity="info">
                    No questions found for {category} - {subdivision}.
                    <br />
