  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({
        queryKey: ["lessons", "topic", data.topicId],
      });
      enqueueSnackbar("Lesson created successfully", { variant: "success" });
    },
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to create lesson", {
        variant: "error",
      });
    },
  });
...
export const useUpdateLesson = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to update lesson", {
        variant: "error",
      });
    },
  });
...
export const useDeleteLesson = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to delete lesson", {
        variant: "error",
      });
    },
  });
