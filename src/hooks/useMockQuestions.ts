...
export const useCreateMockQuestion = () => {
  ...
  return useMutation({
    mutationFn: (input: CreateMockQuestionInput) =>
      mockQuestionsAPI.create(input),
    onSuccess: (data) => {
      queryClient.invalidateQueries({
        queryKey: ["mock-questions", data.examPart],
      });
      enqueueSnackbar("Mock question created successfully", {
        variant: "success",
      });
    },
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to create mock question", {
        variant: "error",
      });
    },
  });
...
export const useUpdateMockQuestion = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      enqueueSnackbar("Mock question updated successfully", {
        variant: "success",
      });
    },
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to update mock question", {
        variant: "error",
      });
    },
  });
...
export const useDeleteMockQuestion = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["mock-questions"] });
      enqueueSnackbar("Mock question deleted successfully", {
        variant: "success",
      });
    },
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to delete mock question", {
        variant: "error",
      });
    },
  });
...
export const useBulkCreateMockQuestions = () => {
  ...
  return useMutation({
    mutationFn: (inputs: CreateMockQuestionInput[]) =>
      mockQuestionsAPI.bulkCreate(inputs),
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: ["mock-questions"] });
      enqueueSnackbar(`${data.length} mock questions created successfully`, {
        variant: "success",
      });
    },
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to create mock questions", {
        variant: "error",
      });
    },
  });
