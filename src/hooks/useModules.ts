...
export const useCreateModule = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to create module', { variant: 'error' })
    },
  })
}
...
export const useUpdateModule = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to update module', { variant: 'error' })
    },
  })
}
...
export const useDeleteModule = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to delete module', { variant: 'error' })
    },
  })
}
...
export const useUploadThumbnail = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to upload thumbnail', { variant: 'error' })
    },
  })
}
