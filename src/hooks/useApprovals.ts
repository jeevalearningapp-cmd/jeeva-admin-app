...
export const useCreateApproval = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to submit for approval", {
        variant: "error",
      });
    },
  });
...
export const useReviewApproval = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to review content", {
        variant: "error",
      });
    },
  });
...
export const useDeleteApproval = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || "Failed to delete approval", {
        variant: "error",
      });
    },
  });
