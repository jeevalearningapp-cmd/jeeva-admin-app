...
export const useCreateFlashcard = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to create flashcard', { variant: 'error' })
    },
  })
}
...
export const useUpdateFlashcard = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to update flashcard', { variant: 'error' })
    },
  })
}
...
export const useDeleteFlashcard = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      enqueueSnackbar(error.message || 'Failed to delete flashcard', { variant: 'error' })
    },
  })
}
