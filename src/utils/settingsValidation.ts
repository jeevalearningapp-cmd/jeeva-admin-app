...
export const validateSettings = (
  ...
  if (
    settings.maxFileUploadSize !== undefined &&
    settings.maxFileUploadSize !== null
  ) {
    ...
    if (
      ...
      errors.push({
        field: "maxFileUploadSize",
        message: "File upload size must be at least 1 MB",
      });
    } else if (size > 100) {
      errors.push({
        field: "maxFileUploadSize",
  ...
  if (
    settings.passwordMinLength !== undefined &&
    settings.passwordMinLength !== null
  ) {
