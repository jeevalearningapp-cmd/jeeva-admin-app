...
export const LEARNING_TOPICS: LearningTopic[] = [
  ...
  },
  {
    ...
    subtopics: [
      ...
      },
      {
        ...
        description:
          "2-stage test (understanding, retaining, weighing, communicating)",
      },
      {
        id: "4.3",
  ...
  {
    id: "22222222-2222-0009-0000-000000000009",
    title: "Cultural Adaptation",
    description:
      "Working effectively in a multicultural healthcare environment",
    subtopics: [
      {
        id: "9.1",
...
export function getAllSubtopics(): Array<{
  ...
  LEARNING_TOPICS.forEach((topic) => {
    if (topic.subtopics.length === 0) {
      throw new Error(
        `Topic "${topic.title}" has no subtopics. All topics must have subtopics.`,
      );
    }
