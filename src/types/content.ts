...
export interface Lesson {
  ...
  videoUrl?: string;
  audioUrl?: string;
  podcastUrl?: string; // New field
  lessonType?: LessonType;
  contentType?: LessonType; // New field mapped to DB content_type
  isMandatory?: boolean; // New field
  passingScorePercentage?: number;
  category?: string; // Legacy, mapped to subtopic_id
  subtopicId?: string; // New field
  duration?: number;
  isActive: boolean;
  displayOrder: number;
  createdAt: string;
