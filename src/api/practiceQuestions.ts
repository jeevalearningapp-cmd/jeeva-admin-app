...
export const practiceQuestionsAPI = {
    async getByFilter(category: string, subdivision: string): Promise<PracticeQuestion[]> {
    ...
    async update(id: string, input: UpdatePracticeQuestionInput): Promise<PracticeQuestion> {
    ...
    async bulkCreate(inputs: CreatePracticeQuestionInput[]): Promise<PracticeQuestion[]> {
